...
export default function ThirdSection() {
  ...
  const [bouncingWineId, setBouncingWineId] = useState(null); // Stato per gestire l'animazione di rimbalzo
  ...
  const handleCardClick = (wineId) => {
    ...
    setTimeout(() => {
      setBouncingWineId(null); // Rimuovi l'effetto dopo un breve intervallo
    }, 500);
  };
